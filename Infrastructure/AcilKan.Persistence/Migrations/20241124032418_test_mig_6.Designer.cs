...
namespace AcilKan.Persistence.Migrations
{
    ...
    [Migration("20241124032418_test_mig_6")]
    partial class test_mig_6
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AcilKan.Domain.Entities.BloodDontaion", b =>
                {
                    ...
                    b.Property<int>("BloodDontaionStatusId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BloodDontaionStatusId");

                    b.HasIndex("BloodRequestId");

                    b.HasIndex("DonorId");

                    b.ToTable("BloodDontaion");
                });

            modelBuilder.Entity("AcilKan.Domain.Entities.BloodDontaionStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BloodDontaionStatuses");
                });
            ...
            modelBuilder.Entity("AcilKan.Domain.Entities.BloodRequest", b =>
                {
                    ...
                    b.Property<int>("BloodRequestStatusId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BloodRequestStatusId");
            ...
            modelBuilder.Entity("AcilKan.Domain.Entities.BloodRequestStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BloodRequestStatuses");
                });
            ...
            modelBuilder.Entity("AcilKan.Domain.Entities.BloodDonationApprove", b =>
                {
                    b.HasOne("AcilKan.Domain.Entities.BloodDontaion", "BloodDontaion")
                        .WithMany()
            ...
            modelBuilder.Entity("AcilKan.Domain.Entities.BloodDontaion", b =>
                {
                    b.HasOne("AcilKan.Domain.Entities.BloodDontaionStatus", "BloodDontaionStatus")
                        .WithMany()
                        .HasForeignKey("BloodDontaionStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("BloodDontaionStatus");
            ...
            modelBuilder.Entity("AcilKan.Domain.Entities.BloodRequest", b =>
                {
                    ...
                    b.HasOne("AcilKan.Domain.Entities.BloodRequestStatus", "BloodRequestStatus")
                        .WithMany()
                        .HasForeignKey("BloodRequestStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("BloodRequestStatus");
